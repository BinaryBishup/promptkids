  ...
  return (
    <div className="min-h-screen bg-pk-gray-light flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-extrabold text-pk-text mb-2">Programs</h1>
        <p className="text-pk-text-secondary text-sm mb-6">This page is coming soon. Explore our AI learning programs for Class 6–12.</p>
