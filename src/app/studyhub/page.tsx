    ...
    return (
      <div className="min-h-screen bg-[#f8fafc] flex flex-col" style={bFont}>
        ...
        <div className="flex-1 flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-[380px] flex-shrink-0 bg-white border-t lg:border-t-0 lg:border-l-2 border-[#eef0f4] flex flex-col">
            {/* AI Help Levels */}
            <div className="p-5 border-b border-[#e5e7eb]">
              <h3 className="flex items-center gap-2 text-[15px] text-[#0f172a] mb-4" style={dFont}>
                    ...
                    <button
                      ...
                      className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 transition-all duration-200 text-left ${
                        isActive
                          ...
                          : isUnlocked
                          ? "border-[#e5e7eb] hover:border-purple-200 hover:bg-purple-50/30 cursor-pointer"
                          : "border-[#e5e7eb] bg-gray-50/50 opacity-50 cursor-not-allowed"
                      }`}
                    >
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                        isActive ? "bg-purple-500 text-white" : isUnlocked ? "bg-purple-100 text-purple-500" : "bg-gray-200 text-gray-400"
                      }`}>
                        {isUnlocked ? <CircleCheck size={16} /> : <Lock size={14} />}
                      </div>
                      <div className="flex-1 min-w-0">
                        <span className="text-[13px] text-[#0f172a] block" style={dFont}>L{hl.level}: {hl.name}</span>
                        <span className="text-[11px] text-[#94a3b8] block" style={bFont}>{hl.desc}</span>
                      </div>
                      {!isUnlocked && (
                        <span className="text-[10px] text-[#94a3b8] flex-shrink-0" style={bFont}>{hl.attemptsNeeded - attempts} more</span>
                      )}
                    </button>
                  );
                })}
            ...
            <div className="flex-1 flex flex-col min-h-[300px]">
              {!chatOpen ? (
                <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
                  ...
                  <p className="text-[15px] text-[#374151] mb-2" style={dFont}>
                    {attempts > 0 ? "Select a help level to chat" : "Submit an attempt first"}
                  </p>
                  <p className="text-[13px] text-[#94a3b8]" style={bFont}>
                    {attempts > 0 ? "Click any unlocked level above to get AI assistance" : "Try answering the question, then unlock AI help"}
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex items-center justify-between bg-gradient-to-r from-[#2563eb] to-[#7c3aed] px-5 py-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="text-white text-[14px]" style={dFont}>Level {chatLevel} Help</span>
                    </div>
                  ...
                  <div className="border-t border-[#e5e7eb] p-3">
                    ...
                    >
                      <input
                        ...
                        className="flex-1 bg-[#f8fafc] border-2 border-[#e5e7eb] rounded-xl px-4 py-2.5 text-[13px] text-[#0f172a] placeholder:text-[#94a3b8] focus:outline-none focus:border-purple-400"
                      />
