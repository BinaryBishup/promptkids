  ...
  if (step === "subjects") {
    return (
      <div className="min-h-screen bg-[#f8fafc]" style={bFont}>
        <AppHeader breadcrumbs={[{ label: "Dashboard", href: "/dashboard" }, { label: "Study Buddy" }]} />
        <div className="max-w-5xl mx-auto px-6 py-12">
          <h1 className="text-[36px] text-[#0f172a] mb-3" style={dFont}>Study Buddy</h1>
          <p className="text-[18px] text-[#64748b] mb-10" style={bFont}>Choose the subject you need help with</p>
